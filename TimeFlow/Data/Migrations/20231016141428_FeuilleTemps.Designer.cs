...
namespace TimeFlow.Data.Migrations
{
    ...
    [Migration("20231016141428_FeuilleTemps")]
    partial class FeuilleTemps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeFlow.Models.FeuilleJour", b =>
                {
                    ...
                    b.Property<int?>("FeuilleTempsAnnee")
                        .HasColumnType("int");

                    b.Property<string>("FeuilleTempsEmployeId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("FeuilleTempsProjetId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int?>("FeuilleTempsSemaine")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FeuilleTempsAnnee", "FeuilleTempsSemaine", "FeuilleTempsEmployeId", "FeuilleTempsProjetId");
            ...
            modelBuilder.Entity("TimeFlow.Models.FeuilleTemps", b =>
                {
                    ...
                    b.HasKey("Annee", "Semaine", "EmployeId", "ProjetId");
            ...
            modelBuilder.Entity("TimeFlow.Models.Tache", b =>
                {
                    ...
                    b.HasIndex("Annee", "Semaine", "MembreChargeId", "ProjetId");
            ...
            modelBuilder.Entity("TimeFlow.Models.FeuilleJour", b =>
                {
                    b.HasOne("TimeFlow.Models.FeuilleTemps", null)
                        .WithMany("Jours")
                        .HasForeignKey("FeuilleTempsAnnee", "FeuilleTempsSemaine", "FeuilleTempsEmployeId", "FeuilleTempsProjetId");
                });
            ...
            modelBuilder.Entity("TimeFlow.Models.Tache", b =>
                {
                    ...
                    b.HasOne("TimeFlow.Models.FeuilleTemps", "FeuilleTemps")
                        .WithMany("Taches")
                        .HasForeignKey("Annee", "Semaine", "MembreChargeId", "ProjetId");
