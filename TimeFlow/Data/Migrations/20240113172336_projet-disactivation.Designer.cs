...
namespace TimeFlow.Data.Migrations
{
    ...
    [Migration("20240113172336_projet-disactivation")]
    partial class projetdisactivation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeTache", b =>
                {
                    b.Property<string>("MembresChargeId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("TachesId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("MembresChargeId", "TachesId");

                    b.HasIndex("TachesId");

                    b.ToTable("EmployeTache");
                });
            ...
            modelBuilder.Entity("EmployeTache", b =>
                {
                    b.HasOne("TimeFlow.Models.Employe", null)
                        .WithMany()
                        .HasForeignKey("MembresChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TimeFlow.Models.Tache", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TimeFlow.Models.FeuilleTemps", b =>
                {
                    b.HasOne("TimeFlow.Models.Employe", "Employe")
                        .WithMany("FeuilleTemps")
